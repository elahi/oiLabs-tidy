...
```{r global_options, include=FALSE, fig.width = 5}
...
```{r r-interface-2020, echo = FALSE, out.width = "5in"}
knitr::include_graphics("img/r-interface-2020.png")
```

<!-- ![rinterface](img/r-interface-2020.png) -->
...
*Why use R Markdown for Lab Reports?* [https://youtu.be/lNWVQ2oxNho](https://youtu.be/lNWVQ2oxNho)
<iframe width="560" height="315" src="https://www.youtube.com/embed/lNWVQ2oxNho" frameborder="0" allowfullscreen></iframe>

*How to use R Markdown for Lab Reports in RStudio* [https://youtu.be/o0h-eVABe9M](https://youtu.be/o0h-eVABe9M)
...
In a nuthshell, in RStudio, go to New File -> R Markdown... Then, type in the name of the lab (e.g., Intro to R and RStudio) and hit ok. As in the video above, insert the following code at the top of your RMarkdown document, just below the YAML header with the title, author, date, and output information:

```{r rmd_template, echo = FALSE, results = "asis"}
knitr::include_graphics("img/rmd_template.png")
```

<!-- ![Rmd template](img/rmd_template.png){width=50%} -->
